...
**Still not built** (this remains backend-only, deliberately):
- The frontend "progress centre" UI — the API now exists to build it against, but no page/component was added.
